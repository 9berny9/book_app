...
tolkien_readers = dataset_lowercase['User-ID'][(dataset_lowercase['Book-Title']=='wild animus') & (dataset_lowercase['Book-Author'].str.contains("shapero"))]
